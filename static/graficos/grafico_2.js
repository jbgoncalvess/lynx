const ctx = document.getElementById('smallBarChart').getContext('2d');

// Configurações do gráfico de barras
const smallBarChart = new Chart(ctx, {
    type: 'bar',
    data: {
...
const ctx_2 = document.getElementById('smallBarChart2').getContext('2d');

// Configurações do gráfico de barras
const smallBarChart_2 = new Chart(ctx_2, {
    type: 'bar',
    data: {
        labels: ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho'], // Exemplo de meses
        datasets: [{
